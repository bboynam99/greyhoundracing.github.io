function CFichesController(iScale,oParentContainer, iStyle){
    var _bFichesUpdate;
    var _iTimeElaps;
    var _iValue;
    var _iCurScale;
    ...
    this._init= function(iScale){
        ...
        var szFontSize = 18;
        _oBetAmountText =  new createjs.Text("",szFontSize+"px "+PRIMARY_FONT, "#ffff00");
    ...
    this.refreshFiches = function(aFiches,iXPos,iYPos){
        ...
        playSound("chip", 1, 0);
		if(_iStyle == 1){
        	_oBetAmountText.x = iXPos - 52;
       		_oBetAmountText.y = iYPos - (25*_iCurScale);
		} else{
        	_oBetAmountText.x = iXPos - 30;
        	_oBetAmountText.y = iYPos - 16;
		}
        _oBetAmountText.text = _iValue;
    };
	//
