function CLosePanel(oParentContainer){
    ...
    this._init = function(){
        ...
        _aBibs = new Array();
        var oBib1 = createSprite(_oSpriteSheetBib,"bib_0");
        oBib1.x = CANVAS_WIDTH/2 - 100 - _iWidthBib/2;
        oBib1.y = 350;
        _oContainer.addChild(oBib1);
        _aBibs.push(oBib1);
        var oBib2 = createSprite(_oSpriteSheetBib,"bib_0");
        oBib2.x = CANVAS_WIDTH/2 - _iWidthBib/2;
        oBib2.y = 350;
        _oContainer.addChild(oBib2);
        _aBibs.push(oBib2);
        var oBib3 = createSprite(_oSpriteSheetBib,"bib_0");
    ...
    this.show = function(aRank){
        for(var j=0;j<3;j++)_aBibs[j].gotoAndStop("bib_"+aRank[j]);
