function CChipPanel(iX,iY,oParentContainer){//@
    ...
    this._init = function(iX,iY){
		...
		//
        _oClearBetBtn = new CTextButton(100,30,s_oSpriteLibrary.getSprite("but_clear_bet"), TEXT_CLEAR_BET, PRIMARY_FONT, "#fff", 22,_oContainer);
        ...
        //
        _oTextMaxBet = new createjs.Text(TEXT_MAX_BET + ": " + game_MaxBet_newTRX, "19px " + SECONDARY_FONT, "#ffde00");//MAX_BET
    ...
    this.refreshMoney = function(){
		var iMoney = START_CREDIT;//MY_BALANCES[MY_ODDS.COIN_TYPE].available;
		iMoney = numberFormat(iMoney, {decimals: 2, clear_decimals: true, limit_length_decimals: 10});
