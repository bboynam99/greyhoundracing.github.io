function CSimpleBetPanel(iX,iY,oParentContainer){
    ...
    this._init = function(iX,iY){
        ...
        oText.y = 24;
        _oContainer.addChild(oText);
        var oText = new createjs.Text(TEXT_SHOW+" - 3th", "20px " + PRIMARY_FONT, "#fff");
        oText.textAlign = "center";
        oText.textBaseline = "alphabetic";
        oText.x = 630;
        oText.y = 24;
        ...
        for(var i=0;i<NUM_GREYHOUNDS;i++){
            var oBib = createSprite(oSpriteSheetBib,"bib_"+i);
            oBib.x = 28;
            oBib.y = iYBib;
    ...
    this._initGreyhoundInfos = function(){
        ...
        for(var i=0;i<NUM_GREYHOUNDS;i++){
            ...
            var oGreyhound = createSprite(oSpriteSheetGreyhound,"idle");
            oGreyhound.x = 150;
            oGreyhound.y = iY;
            oGreyhound.scaleX = oGreyhound.scaleY = 0.5;
            _oContainer.addChild(oGreyhound);
            _aGreyhoundSprite.push(oGreyhound);
            var oText = new createjs.Text(aNames[i].toUpperCase(), "16px " + TERTIARY_FONT, "#fff");
    ...
    this._initBetPlaces = function(){
        ...
        for(var i=0;i<NUM_GREYHOUNDS;i++){
            ...
            //BET SHOW
            var oText = new createjs.Text("x"+s_oGameSettings.getOddShow(i), "20px " + TERTIARY_FONT, "#fff");
            oText.textAlign = "center";
            oText.textBaseline = "middle";
            oText.x = iX + 268;
            oText.y = iY+18;
